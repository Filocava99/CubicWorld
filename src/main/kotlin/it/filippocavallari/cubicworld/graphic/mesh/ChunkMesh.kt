...
class ChunkMesh(private val chunk: Chunk,private val material: Material, private val resourceManager: ResourceManager) {
    ...
    private fun addFace(faceDirection: FaceDirection, blockId: Int, coord: Vector3f) {
        ...
        bakedModel?.let {
            val indexOffset = if(blockId == BlockMaterial.WATER.id)waterVerticesList.size/3 else verticesList.size/3
            var i = 0
