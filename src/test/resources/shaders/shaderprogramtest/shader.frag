/*
    THIS SHADER DOES NOT MAKE ANY SENSE. IT WAS MADE ONLY FOR TEST PURPOSES.
    DO NOT USE IT FOR ANYHING ELSE.
*/
...
void setupColors(Material material, vec2 textCoord){
    if(material.hasTexture == 1 && flag == 1){
        ambientColor = ambientColorBis;
        diffuseColor = ambientColor;
        specularColor = specularColor;
    }else{
        ambientColor.xyzw = material.ambient.xyzw;
